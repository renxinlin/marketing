...
public class H5SalerRuleExchangeController extends SalerCommonController {
    ...
    public RestResult reward(@Valid @RequestBody OutCodeInfoDto codeInfo, @ApiIgnore H5LoginVO user) throws Exception {
        ...
        Integer integral = rewardService.getIntegral(codeInfo.getOuterCodeId(), codeInfo.getCodeTypeId(),H5SalerRuleExchangeTransfer.getRewardValueObject(productByCode), user);
