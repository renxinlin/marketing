...
public interface MarketingMemberCouponMapper {
    ...
    @Insert({
        ...
        "ObtainCustomerId, DeductionDate, ObtainCustmerName,",
        ...
        "#{obtainCustomerId,jdbcType=VARCHAR}, #{deductionDate,jdbcType=DATE}, #{obtainCustmerName,jdbcType=VARCHAR}, ",
        "#{createTime,jdbcType=TIMESTAMP}, #{verifyCustomerId,jdbcType=VARCHAR}, ",
    ...
    @Select({
        ...
        "ProductBatchName, SbatchId, ProductName, ObtainCustomerId, DeductionDate, CreateTime, ObtainCustmerName,",
