...
public interface MarketingMemberCouponMapper {
    ...
    @Insert({
        ...
        "VerifyCustomerName,VerifyMemberId, VerifyPersonName, ",
        ...
        "#{verifyCustomerName,jdbcType=VARCHAR},#{verifyMemberId,jdbcType=BIGINT}, #{verifyPersonName,jdbcType=VARCHAR}, ",
    ...
    @Select({
        ...
        "VerifyCustomerId, VerifyCustomerName,VerifyMemberId, VerifyPersonName, VerifyPersonPhone, VerifyTime, ",
        "VerifyPersonType, Used",
    ...
    @Results({
        ...
        @Result(column="VerifyMemberId", property="verifyMemberId", jdbcType=JdbcType.BIGINT),
    ...
    @Update({
        ...
        "set MemberId = #{memberId,jdbcType=BIGINT},",
          ...
          "VerifyMemberId = #{verifyMemberId,jdbcType=BIGINT},",
