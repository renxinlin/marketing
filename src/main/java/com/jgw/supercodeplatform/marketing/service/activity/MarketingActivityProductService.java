...
public class MarketingActivityProductService {
	...
	public JSONObject relationActProds(String organizationId) throws SuperCodeException {
		...
		ResponseEntity<String>responseEntity=restTemplateUtil.getRequestAndReturnJosn("http://PLATFORM-CODEMANAGER-SUPERCODE-ZC"+CommonConstants.RELATION_PRODUCT_PRODUCT_BATCH, params, null);
