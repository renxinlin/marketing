...
public class CommonConstants {
     ...
     * 请求码管理进行码关联过的产品路径
     */
    // todo  码管理url变更/code/relation/list/relation/productRecord
    public static final String CODEMANAGER_RELATION_PRODUCT_URL = "/code/relation/list/relation/productRecord/forMarketing";

    
    /**
     * 请求码管理进行码关联过的产品和产品批次
     */
    // todo  码管理url变更/code/relation/list/product/forRelation
    public static final String CODEMANAGER_RELATION_PRODUCT_PRODUCT_BATCH = "/code/relation/list/product/forRelation/forMarketing";
