...
import com.jgw.supercodeplatform.mutiIntegral.infrastructure.mysql.batchdao.IntegralRuleService;
import com.jgw.supercodeplatform.mutiIntegral.infrastructure.mysql.pojo.IntegralRule;
...
public class IntegralRuleController  extends SalerCommonController{
    ...
    public RestResult save(@RequestBody IntegralRule obj)   {
        return success();
    }
    ...
    @ApiOperation(value = "", notes = "")
    @ApiImplicitParam(name = "super-token", paramType = "header", defaultValue = "64b379cd47c843458378f479a115c322", value = "token信息", required = true)
    public RestResult update(@RequestBody IntegralRule obj)   {
        return success();
    }
    ...
    @ApiOperation(value = "", notes = "")
    @ApiImplicitParam(name = "super-token", paramType = "header", defaultValue = "64b379cd47c843458378f479a115c322", value = "token信息", required = true)
    public RestResult list(IntegralRule obj)   {
        return null;
    }
